    ...
    <footer className="site-footer">
      <div className="site-footer-row">
        ...
        <div className="site-footer-links">
          <a href="mailto:solenecrzt01@gmail.com">
            solenecrzt01@gmail.com
          </a>
...
<section className="about-cv-section">
  <img
    src="/images/CV%20pro.png"
    alt="CV de Solène Crouzet"
    className="about-cv"
  />
</section>
...
/* ===== CORRECTIONS TÉLÉPHONE ===== */

/* ----- À PROPOS ----- */

/* Toute la partie reste dans la largeur du téléphone */
.about-teaser {
  width: 100% !important;
...
/* Photo centrée et adaptée au téléphone */
.about-teaser-portrait {
  width: 90% !important;
...
/* Une seule colonne sur téléphone pour éviter que ça déborde */
.contact-info {
  grid-template-columns: 1fr !important;
  width: 100% !important;
  gap: 18px !important;
...
/* Chaque contact reste entièrement visible */
.contact-item {
  width: 100% !important;
  max-width: 100% !important;
  box-sizing: border-box !important;
